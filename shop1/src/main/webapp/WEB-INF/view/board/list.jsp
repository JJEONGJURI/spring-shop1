...
<body>
	...
	<table class="w3-table w3-border">
		...
		<c:if test="${listcount > 0 }"> <!-- 게시판 종류별 등록된 게시물 건수 -->
			<tr>
			...
			<c:forEach var="board" items="${boardlist}"> <!-- boardlist : 현재 화면에 보여줘야 할 게시물 목록 -->
				<tr>
					<td>${boardno}</td> <%-- boardno : 화면에 보여질 가상번호 --%>
					...
					<td>
						...
						<c:if test="${today == rdate}"> <%--현재 등록된 게시물이 오늘 날짜랑 같으면 시,분,초 나타내기 --%>
