			...
			<tr>
				...
				<td>
					<input type="text" name="recipient" size="100" 
						value=
'<c:forEach items="${list}" var="user">${user.username} &lt;${user.email}&gt;,</c:forEach>' class="w3-input">
				</td>
			</tr>
			<tr>
				<td>제목</td>
				<td>
					<input type="text" name="title" size="100" class="w3-input">
				</td>
			</tr>
			<tr>
				<td>메세지형식</td>
